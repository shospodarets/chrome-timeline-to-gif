...
TimelineToGif.prototype.initCanvas = function (capturedFrames, fileName) {
...
TimelineToGif.prototype.dataToGif = function (capturedFrames, fileName) {
    ...
    Promise.all(
        ...
        .then(function (loadedImages) {
            ...
            this.imagesToGif(capturedFrames, loadedImages, fileName);
...
TimelineToGif.prototype.imagesToGif = function (capturedFrames, loadedImages, fileName) {
...
TimelineToGif.prototype.downloadCanvasAsImage = function (data_url, fileName) {
